...
import { ThreadUpdateManyWithoutMentionUserNestedInput } from '../thread/thread-update-many-without-mention-user-nested.input';
...
@InputType()
export class UserUpdateWithoutFollowingsInput {
