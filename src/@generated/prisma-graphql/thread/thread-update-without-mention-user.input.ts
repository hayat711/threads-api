...
import { UserUpdateOneRequiredWithoutThreadsNestedInput } from '../user/user-update-one-required-without-threads-nested.input';
...
@InputType()
export class ThreadUpdateWithoutMentionUserInput {
    ...
    @Field(() => UserUpdateOneRequiredWithoutThreadsNestedInput, {nullable:true})
