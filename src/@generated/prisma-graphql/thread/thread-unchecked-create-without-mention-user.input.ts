...
import { LikeUncheckedCreateNestedManyWithoutThreadInput } from '../like/like-unchecked-create-nested-many-without-thread.input';

@InputType()
export class ThreadUncheckedCreateWithoutMentionUserInput {
    ...
    @Field(() => LikeUncheckedCreateNestedManyWithoutThreadInput, {nullable:true})
